...
# You are also given a target number, and you must write a function that returns an array of the 
# row and column indices of the target number if it is contained in the matrix and [-1, -1] if it 
